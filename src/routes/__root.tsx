...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#02AC87" },
      { name: "color-scheme", content: "light" },
      { title: "Nadeem Saif — Creative Technologist & Marketing Designer" },
      {
        name: "description",
        content:
          "Nadeem Saif — Creative Technologist & Marketing Designer based in Germany. Branding, UX/UI, marketing, content creation, and AI-assisted product development.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Geist+Mono:wght@400;500&family=Inter:wght@400;500;600;700;900&family=Instrument+Serif:ital@1&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
